...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.workspaceArchiveTasks": "归档任务",
    "chat.workspaceCleanupTasks": "清理任务",
    "chat.workspaceTaskMaintenanceRunning": "项目中仍有后台任务运行，暂时不能归档或清理任务。",
    "chat.workspaceCleanupTasksConfirm": "清理「{name}」的任务？",
    "chat.workspaceCleanupTasksDescription":
      "将永久删除此项目的所有已归档任务，以及超过 3 天未活动的未归档任务。此操作无法撤销。",
    "chat.workspaceArchiveTasksFailed": "归档项目任务失败",
    "chat.workspaceCleanupTasksFailed": "清理项目任务失败",
    "chat.workspaceArchivedGroup": "已归档（{count}）",
    "chat.workspaceConversationsExpand": "展开工作空间对话",
    "chat.workspaceConversationsCollapse": "收起工作空间对话",
    "chat.workspaceConversationsLoading": "正在读取工作空间对话…",
    "chat.workspaceConversationsEmpty": "此工作空间暂无对话",
    "chat.workspaceConversationsRetry": "重试",
    "chat.workspaceConversationsShowLatest": "收起到最近 5 条",
    "chat.workspaceConversationsLoadMore": "加载更多 10 条",
    ...
    "chat.statusRunCompletedUnseen": "任务已完成，尚未查看",
    "chat.statusRunFailedUnseen": "任务失败，尚未查看",
    "chat.statusRunCancelledUnseen": "任务已取消，尚未查看",
    "chat.delete": "删除",
    "chat.remove": "移除",
    ...
    "chat.manualCompactCompleted": "上下文压缩完成",
    "chat.editMessage": "编辑消息",
    "chat.cancel": "取消",
    "chat.queue.title": "等待队列 {count}",
    "chat.queue.addToQueue": "加入队列",
    "chat.queue.interruptAndSend": "打断并发送",
    "chat.runningSend.insertBeforeNextTurn": "下一轮前插入",
    "chat.runningSend.switching": "正在切换…",
    ...
    "settings.globalShortcutsDesc":
      "F2 固定用于在任意应用中快速呼出或隐藏主窗口。其他操作可点击条目录制组合键，按 Enter 或点击空白处完成，Esc 取消。",
    "settings.shortcutToggle": "快速呼出 / 隐藏窗口",
    "settings.shortcutToggleDesc":
      "固定使用系统全局热键 F2；LiveAgent 在前台且聚焦时隐藏，否则立即呼出并聚焦",
    ...
    "settings.trayRunningBadge": "任务状态徽标",
    "settings.trayRunningBadgeDesc":
      "macOS 菜单栏显示运行数；Windows 任务栏显示尚未查看的完成任务数。",
    "settings.light": "浅色",
    ...
    "settings.runningAgentSendMode": "Agent 运行中发送方式",
    "settings.runningAgentSendModeInterrupt": "直接发送",
    "settings.runningAgentSendModeInterruptDesc": "停止当前 Agent，完成收尾后立即发送为新的运行。",
    "settings.runningAgentSendModeSteer": "下一轮前插入",
    "settings.runningAgentSendModeSteerDesc": "不停止当前 Agent，在本轮结束后、下一轮模型调用前插入。",
    ...
    "settings.agentsProactiveDelegation": "主动委派",
    "settings.agentsProactiveDelegationHint":
      "优先将边界清晰的日常开发、测试、重构和独立验证交给 Agent，并由父代理负责整合与最终验收；关闭时恢复现有的保守委派策略。",
    "settings.agentsFastModel": "快速模型",
    "settings.agentsFastModelHint":
      "用于 Agent 的搜索、整理和简单验证；开启主动委派后也用于常规日常开发任务。未选择时跟随当前对话模型。",
    "settings.agentsFastModelFollow": "跟随当前对话模型",
    "settings.agentsFastModelEmpty": "当前没有已激活的模型，请先在供应商设置中激活模型。",
    "settings.agentsMaxRounds": "最大执行轮数",
    "settings.agentsMaxRoundsHint":
      "默认 50。达到上限前一轮后停止调用工具，并在最后一轮总结当前结果后返回（2-200）。",
  ...
  "en-US": {
    ...
    "chat.workspaceArchiveTasks": "Archive tasks",
    "chat.workspaceCleanupTasks": "Clean up tasks",
    "chat.workspaceTaskMaintenanceRunning":
      "A background task is still running in this project, so its tasks cannot be archived or cleaned up yet.",
    "chat.workspaceCleanupTasksConfirm": 'Clean up tasks in "{name}"?',
    "chat.workspaceCleanupTasksDescription":
      "This permanently deletes every archived task in the project and every unarchived task inactive for more than 3 days. This cannot be undone.",
    "chat.workspaceArchiveTasksFailed": "Failed to archive project tasks",
    "chat.workspaceCleanupTasksFailed": "Failed to clean up project tasks",
    "chat.workspaceArchivedGroup": "Archived ({count})",
    "chat.workspaceConversationsExpand": "Expand workspace conversations",
    "chat.workspaceConversationsCollapse": "Collapse workspace conversations",
    "chat.workspaceConversationsLoading": "Loading workspace conversations…",
    "chat.workspaceConversationsEmpty": "No conversations in this workspace",
    "chat.workspaceConversationsRetry": "Retry",
    "chat.workspaceConversationsShowLatest": "Show latest 5",
    "chat.workspaceConversationsLoadMore": "Load 10 more",
    ...
    "chat.statusRunCompletedUnseen": "Task completed, not yet viewed",
    "chat.statusRunFailedUnseen": "Task failed, not yet viewed",
    "chat.statusRunCancelledUnseen": "Task cancelled, not yet viewed",
    "chat.delete": "Delete",
    "chat.remove": "Remove",
    ...
    "chat.manualCompactBelowThreshold":
      "Context usage is below 50%; compaction is not needed yet",
    ...
    "chat.manualCompactCompleted": "Context compaction completed",
    ...
    "chat.runningSend.insertBeforeNextTurn": "Insert Before Next Turn",
    "chat.runningSend.switching": "Switching…",
    ...
    "settings.globalShortcutsDesc":
      "F2 is fixed for summoning or hiding the main window from any app. Click another action to record its combo, then press Enter or click elsewhere to confirm. Esc cancels.",
    "settings.shortcutToggle": "Quick Summon / Hide Window",
    "settings.shortcutToggleDesc":
      "Fixed system-wide F2 shortcut: hide LiveAgent when focused, otherwise summon and focus it",
    ...
    "tray.show": "Show / Hide Main Window",
    ...
    "settings.trayRunningBadge": "Task status badge",
    "settings.trayRunningBadgeDesc":
      "Show running chats in the macOS menu bar and unseen completed tasks on the Windows taskbar.",
    ...
    "settings.runningAgentSendMode": "Sending While Agent Is Running",
    "settings.runningAgentSendModeInterrupt": "Send Directly",
    "settings.runningAgentSendModeInterruptDesc":
      "Stop the current Agent, finish cleanup, then send immediately as a new run.",
    "settings.runningAgentSendModeSteer": "Insert Before Next Turn",
    "settings.runningAgentSendModeSteerDesc":
      "Keep the current Agent running and insert after this turn, before the next model request.",
    ...
    "settings.agentsProactiveDelegation": "Proactive delegation",
    "settings.agentsProactiveDelegationHint":
      "Prefer Agent for bounded routine development, tests, refactoring, and independent verification, while the parent integrates and performs final validation. Turn it off to restore the current conservative delegation policy.",
    "settings.agentsFastModel": "Fast model",
    "settings.agentsFastModelHint":
      "Used for Agent search, synthesis, and simple verification; proactive delegation also uses it for routine development jobs. If unset, it uses the current chat model.",
    ...
    "settings.agentsMaxRounds": "Maximum execution rounds",
    "settings.agentsMaxRoundsHint":
      "Defaults to 50. Before the limit, tools are disabled and the final round summarizes the current results (2-200).",
    ...
    "settings.skillsScanHint": "Rescan the LiveAgent Skills directory and sync capabilities available to this conversation",
