...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.workspaceTaskMaintenanceDisconnected": "Gateway 未连接，暂时不能归档或清理项目任务。",
  ...
  "en-US": {
    ...
    "chat.workspaceTaskMaintenanceDisconnected":
      "The Gateway is disconnected, so project tasks cannot be archived or cleaned up right now.",
